...
export function Field({
	...
	return (
		<div className={cn(
			'flex gap-2 w-full',
			orientation === 'vertical' ? 'flex-col' : 'flex-col sm:flex-row sm:items-center justify-between sm:gap-8 border-t border-border/18 py-5 first:border-t-0',
			className
		)}>
			{labelProps && (
				<Label
					...
					className={cn(
						...
						(variant === 'settings' || orientation === 'horizontal') && 'text-[14px] font-semibold text-foreground',
